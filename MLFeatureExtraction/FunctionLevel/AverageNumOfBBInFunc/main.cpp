...
struct ir_instrumentation : public ModulePass{
  ...
  virtual bool runOnModule(Module &M)
  {
    ...
    for(Module::iterator F = M.begin(), E = M.end(); F!= E; ++F)
    {
      ...
      Constant* counterAdd_handler_c = appModule->getOrInsertFunction("updateDenominator", counterAddType); //Function Handler
      ...
      F->begin()->getInstList().insert(F->begin()->end()->getPrevNode(), newInst);
      ...
      if(F->getName() == "main"){
        ...
        FunctionType* counterAddType = FunctionType::get(Type::getVoidTy(context), false); //Function Type
        Constant* counterAdd_handler_c = appModule->getOrInsertFunction("printResult", counterAddType); //Function Handler
      ...
      for(Function::iterator BB = F->begin(), E = F->end(); BB != E; ++BB)
      {
          ...
          FunctionType* counterAddType = FunctionType::get(Type::getVoidTy(context), false); //Function Type
          Constant* counterAdd_handler_c = appModule->getOrInsertFunction("updateNumberator", counterAddType); //Function Handler
          Function *counterAddFunc = dyn_cast<Function>(counterAdd_handler_c); //Function
